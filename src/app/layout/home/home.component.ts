...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const description = 'Senior Mobile Engineer in Bogotá specializing in Android, iOS, Kotlin, Swift, Clean Architecture, fintech apps and scalable mobile products used by millions.';
